                ...
                <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell sx={{ borderRight: "1px solid #1976d2" }}>Investor Username</StyledTableCell>
                            <StyledTableCell sx={{ borderRight: "1px solid #1976d2" }}>Agreement Type</StyledTableCell>
                            <StyledTableCell sx={{ borderRight: "1px solid #1976d2" }}>Agreement Valid Date</StyledTableCell>
                            <StyledTableCell>Is Allotted</StyledTableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                            ...
                            (rowsPerPage > 0
                                ...
                                return (
                                    <TableRow key={i}>
                                        ...
                                        <TableCell component="th" scope="row" sx={{ borderRight: "1px solid #e0e0e0" }}>
                                            {e.gala_investor_contract_detail.owner.username}
                                        </TableCell>
                                        <TableCell component="th" scope="row" sx={{ borderRight: "1px solid #e0e0e0" }}>
                                            {e.gala_investor_contract_detail.user.username}
                                        </TableCell>
                                        <TableCell component="th" scope="row" sx={{ borderRight: "1px solid #e0e0e0" }}>
                                            {e.gala_investor_contract_detail.agreement_type}
                                        </TableCell>
                                        <TableCell component="th" scope="row" sx={{ borderRight: "1px solid #e0e0e0" }}>
                                            2022-12-20
                                        </TableCell>
                                        <TableCell component="th" scope="row">
                                            {e.is_allotted === true
                                                ?
                                                <CheckBoxIcon style={{ color: "#299807", fontSize: "2em" }} />
                                                :
                                                <img src={Delete} width="27" height="25" alt="delete" style={{ marginbottom: "-4px" }} />}
                                        </TableCell>
                                    </TableRow>
                                )
                            })
